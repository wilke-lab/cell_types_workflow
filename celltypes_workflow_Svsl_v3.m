%Code updated on 2/5/20 by Kyle Fang
%This code can now take in as many periods within an epoch as needed, as
%long as the m3p3_range_ItoS and m3p3_range_StoI is formatted as below:
...
% Breaking down long struggle epochs into 3 equal sized chunks, beg,
% middle, end
...
%% Code below works as long as m3p3_range_ItoS and m3p3_range_StoI are matrices with 
%% [start frame 1, end frame 1, start frame 2, end frame 2, etc.]
...
%% number_of_periods
%number_of_periods contains number of rows in m3p3_range_ItoS
...
%%struggle_norm = zeros((size(sig_kd,1)),180);
%%number_of_events_IS = size(struggle_range_long, 1);
...
%% putting into bins of 10 frames
